...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libsodium_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("a9144af2-ca23-56d9-984f-0d03f7b5ccf8"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libsodium", artifacts_toml) for e in artifacts["libsodium"]]
...
if best_platform === nothing
    @debug("Unable to load libsodium; unsupported platform $(triplet(platform_key_abi()))")
else
